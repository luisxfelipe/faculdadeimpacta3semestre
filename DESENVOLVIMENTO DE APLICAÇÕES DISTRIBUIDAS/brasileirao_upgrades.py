...
def nomes_classificados_libertadores(dados):
    ...
    for i in id_classificados:
        nome_classificados.append(nome_do_time(dados, i))
...
def nomes_dos_times_de_um_jogo(dados,id_jogo):
    id_dos_times_de_um_jogo = ids_dos_times_de_um_jogo(dados,id_jogo)
    nome_time1 = nome_do_time(dados, id_dos_times_de_um_jogo[0])
    nome_time2 = nome_do_time(dados, id_dos_times_de_um_jogo[1])
...
def id_do_time(dados,nome_time):
    ...
    i = 0
    print('\n')
    for key in dados['equipes']:
        list_equipes[int(dados['equipes'][key]['id'])] = dados['equipes'][key]['nome-comum']
        lista_equipes = ()
        i+=1
    #pprint(list_equipes)
        
        '''
    if nome_time in list_equipes:
